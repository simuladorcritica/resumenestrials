...
function injectVisualTuning() {
  ...
  style.textContent = `
    ...
    .auth-entry-kicker{font-size:12px!important;letter-spacing:.18em!important;color:var(--rt-ink-soft)!important}.auth-entry-main{font:500 18px/1.05 'Fraunces',serif!important;color:var(--rt-teal-deep)!important;border:0!important}
    ...
    header.sitio::before{content:"EVIDENCIA / ENSAYOS CLÍNICOS / ESPAÑOL";grid-column:1/-1;align-self:start;font:500 13px/1 'IBM Plex Mono',monospace;letter-spacing:.2em;color:var(--rt-teal-deep);margin-bottom:36px}
